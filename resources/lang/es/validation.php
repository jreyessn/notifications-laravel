...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'mobile'            =>  'Celular',
        'quantity'          =>  'Cantidad',
        'programmed_at'     =>  'Fecha de consulta',
        'employee_id'       =>  'Colaborador',
        'patient_id'        =>  'Paciente',
        'medical_consultation_id'   =>  'Consulta médica',
        'cost_center_id'        =>  'Centro de coste',
        'cost_center_type_id'   =>  'Tipo de centro de coste',
        'cost_center_area_id'   =>  'Área de trabajo',
        'patient_cost_center_id'=>  'Centro de coste del paciente',
        'patient_cost_center_area_id'   =>  'Área de trabajo del paciente',
        'last_menstruation'     =>  'Fecha de ultima menstruación',
        'probable_date_birth'   =>  'Fecha probable de parto',
        'family_planning_method'=>  'Método de planificación familiar',
        'uterine_fundus'        =>  'Fondo uteríno',
        'fetal_heart_rate'      =>  'Frecuencia cardíaca fetal',
        'heart_rate'            =>  'Frecuencia cardíaca',
        'gestation_weeks'       =>  'Semanas de gestación',
        'blood_pressure'        =>  'Tensión arterial',
        'size'                  =>  'Talla',
        'weight'                =>  'Peso',
        'pregnancy_id'          =>  'Embarazo',
        'diagnosis'             =>  'Diagnostico',
        'treatment'             =>  'Tratamiento',
        'reason_consultation_id'=>  'Motivo de consutla',
        'type_consultation_id'  =>  'Tipo de consulta',
        'programmed_at'         =>  'Fecha/hora programada',
        'patient_cost_center_id'=>  'Centro de coste del paciente',
        'patient_cost_center_area_id'=>'Área de trabajo del paciente',
        'turn_id'               =>  'Turno',
        'dietetic_hygienic_measuress'   =>  'Medidas higiénico-dietéticas',
        'medical_event_witnesses'         =>  'Testigos',
        'medical_event_witnesses.*.name'  =>  'Nombre del testigo',
